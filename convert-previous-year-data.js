...
// Function to convert 2026 predicted cutoffs (might have different structure)
...
const files = [
    ...
    {
        input: './TGEAPCET_2026_Phase2_Official_Cutoffs.xlsx',
        output: './data/2026-phase2-predicted-cutoffs.json',
