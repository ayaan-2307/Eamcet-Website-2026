...
async function convertAllCutoffData() {
    ...
    // 2. Convert 2026 Phase 1 All Closing Ranks
    const phase1Mapping = {
    ...
    // 3. Convert 2026 Phase 2 Official Cutoffs
    const phase2Mapping = {
        'College Code': 'college_code',
        'College Name': 'college_name',
        'Branch Code': 'branch_code',
    ...
    const phase2Data = convertExcelToStructuredJson(
        './TGEAPCET_2026_Phase2_Official_Cutoffs.xlsx',
        './data/2026-phase2-cutoffs.json',
        {
    ...
    console.log(`✅ 2026 Phase 1 All Closing Ranks: ${phase1Data ? phase1Data.length : 0} records`);
    console.log(`✅ 2026 Phase 2 Official Cutoffs: ${phase2Data ? phase2Data.length : 0} records`);
