...
async function processPhase1Data() {
    const dataDir = '2026 phase 1 data';
    ...
    // Save to JSON file
    fs.writeFileSync('data/closing-ranks-2026-phase1.json', JSON.stringify(allClosingRanks, null, 2));
    console.log('Saved to data/closing-ranks-2026-phase1.json');
